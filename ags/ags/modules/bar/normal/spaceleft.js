    ...
    return Widget.Scrollable({
      ...
      child: Widget.Box({
        ...
        children: [
          ...
          //     label.label = Hyprland.active.client.class.length === 0 ? 'Desktop' : Hyprland.active.client.title;
          //   }),
          // }),
          // Widget.Label({
          //     xalign: 0,
          ...
          Widget.Label({
            ...
            truncate: 'end',
            maxWidthChars: 1, // Doesn't matter, just needs to be non negative
            className: 'txt-small bar-wintitle-txt',
            setup: (self) => self.hook(Hyprland.active.client, label => { // Hyprland.active.client
              label.label = Hyprland.active.client.title.length === 0 ? `Workspace ${Hyprland.active.workspace.id}` : Hyprland.active.client.class;
            }),
          })
        ]
      })
