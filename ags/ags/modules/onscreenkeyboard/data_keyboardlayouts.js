...
export const oskLayouts = {
  ...
  cyrillic_full: {
    name: "Cyrillic - Full",
    name_short: "RU",
    comment: "Russian ЙЦУКЕН layout",
    keys: [
      [
        { keytype: "normal", label: "Esc", shape: "fn", keycode: 41 },
        { keytype: "normal", label: "F1", shape: "fn", keycode: 58 },
        { keytype: "normal", label: "F2", shape: "fn", keycode: 59 },
        { keytype: "normal", label: "F3", shape: "fn", keycode: 60 },
        { keytype: "normal", label: "F4", shape: "fn", keycode: 61 },
        { keytype: "normal", label: "F5", shape: "fn", keycode: 62 },
        { keytype: "normal", label: "F6", shape: "fn", keycode: 63 },
        { keytype: "normal", label: "F7", shape: "fn", keycode: 64 },
        { keytype: "normal", label: "F8", shape: "fn", keycode: 65 },
        { keytype: "normal", label: "F9", shape: "fn", keycode: 66 },
        { keytype: "normal", label: "F10", shape: "fn", keycode: 67 },
        { keytype: "normal", label: "F11", shape: "fn", keycode: 68 },
        { keytype: "normal", label: "F12", shape: "fn", keycode: 69 },
        { keytype: "normal", label: "PrtSc", shape: "fn", keycode: 70 },
        { keytype: "normal", label: "Del", shape: "fn", keycode: 76 }
      ],
      [
        { keytype: "normal", label: "ё", labelShift: "Ё", shape: "normal", keycode: 1 },
        { keytype: "normal", label: "1", labelShift: "!", shape: "normal", keycode: 2 },
        { keytype: "normal", label: "2", labelShift: "\"", shape: "normal", keycode: 3 },
        { keytype: "normal", label: "3", labelShift: "№", shape: "normal", keycode: 4 },
        { keytype: "normal", label: "4", labelShift: ";", shape: "normal", keycode: 5 },
