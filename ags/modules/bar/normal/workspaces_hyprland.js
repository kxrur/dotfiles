...
export default () => EventBox({
  onScrollUp: () => Hyprland.messageAsync(`dispatch workspace e-1`).catch(print),
  onScrollDown: () => Hyprland.messageAsync(`dispatch workspace e+1`).catch(print),
  onMiddleClick: () => toggleWindowOnAllMonitors('osk'),
  onSecondaryClick: () => Hyprland.messageAsync(`dispatch togglespecialworkspace`).catch(print),
  attribute: {
    clicked: false,
    ws_group: 0,
  },
